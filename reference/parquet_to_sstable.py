...
"""
When: 2025-09-13
Where: /mb-datacenter/skxue/mb-data-platform-python/mb_data_platform/dataset2sstable/parquet2sstable.py snapshot
Repo: https://codeup.aliyun.com/modelbest/zyx_infra/blob/main
Description:
    Convert Parquet datasets into SSTable format for downstream training pipelines.
"""
